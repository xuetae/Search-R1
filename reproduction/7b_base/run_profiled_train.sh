...
case "${RUN_MODE}" in
  two_gpu_llama_instruct_time_budget)
    # Llama-2-7B-Chat adaptation. The instruction-tuned checkpoint should
    # follow Search-R1 action tags more reliably than the base checkpoint.
    ...
    # global_steps starts at 1; a limit of 301 executes steps 1 through 300.
    export TOTAL_TRAINING_STEPS="${TOTAL_TRAINING_STEPS:-301}"
