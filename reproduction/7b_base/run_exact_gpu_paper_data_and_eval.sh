...
MAX_PROMPT_LENGTH="${MAX_PROMPT_LENGTH:-3596}" \
...
MAX_TURNS="${EVAL_MAX_TURNS:-${MAX_TURNS:-4}}" \
EVAL_MAX_TURNS="${EVAL_MAX_TURNS:-${MAX_TURNS:-4}}" \
MAX_START_LENGTH="${EVAL_MAX_START_LENGTH:-${MAX_START_LENGTH:-2048}}" \
MAX_PROMPT_LENGTH="${EVAL_MAX_PROMPT_LENGTH:-${MAX_PROMPT_LENGTH:-3596}}" \
MAX_RESPONSE_LENGTH="${EVAL_MAX_RESPONSE_LENGTH:-${MAX_RESPONSE_LENGTH:-500}}" \
MAX_OBS_LENGTH="${EVAL_MAX_OBS_LENGTH:-${MAX_OBS_LENGTH:-500}}" \
